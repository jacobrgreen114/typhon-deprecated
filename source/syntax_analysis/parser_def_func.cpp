...
auto func_def_error_handler_(ParserContext& ctx) -> ParserState {
  throw_not_implemented();
}

constexpr ParserState func_def_error_state =
    ParserState{func_def_error_handler_};
...
constexpr ParserState func_def_body_end_state =
    ParserState{func_def_body_end_handler_};
...
constexpr ParserState func_def_body_start_state =
    ParserState{func_def_body_start_handler_};
...
auto func_def_return_name_handler_(ParserContext& ctx) -> ParserState {
  ...
  return ctx.move_next_state(is_bracket_open, func_def_body_start_state,
                             func_def_error_state,
                             func_def_unexpected_end_error_state);
}

constexpr ParserState func_def_return_name_state =
    ParserState{func_def_return_name_handler_};
...
constexpr ParserState func_def_return_start_state =
    ParserState{func_def_return_start_handler_};
...
auto func_def_param_block_end_handler_(ParserContext& ctx) -> ParserState {
  ...
  return ctx.move_next_state(func_def_error_state,
                             func_def_unexpected_end_error_state, conditions);
  throw_not_implemented();
}
...
constexpr ParserState func_def_param_next_state =
    ParserState{func_def_param_next_handler_};
...
constexpr ParserState func_def_param_end_state =
    ParserState{func_def_param_end_handler_};
  ...
  static constexpr auto conditions =
      std::array<ParserContext::RefMatchCondition, 1>{
          ParserContext::RefMatchCondition{is_colon,
                                           func_def_param_type_start_state}};

  return ctx.move_next_state(func_def_param_end_state,
                             func_def_unexpected_end_error_state, conditions);
}

constexpr ParserState func_def_param_start_state =
    ParserState{func_def_param_start_handler_};
...
auto func_def_identifier_handler_(ParserContext& ctx) -> ParserState {
  ...
  return ctx.move_next_state(is_paren_open, func_def_param_block_start_state,
                             func_def_error_state,
                             func_def_unexpected_end_error_state);
}

constexpr ParserState func_def_identifier_state =
    ParserState{func_def_identifier_handler_};
...
constexpr ParserState func_def_start_state =
    ParserState{func_def_start_handler_};
