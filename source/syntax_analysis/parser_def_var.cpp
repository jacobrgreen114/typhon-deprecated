...
constexpr ParserState var_def_assign_end_state =
    ParserState{var_def_assign_end_handler_};
...
constexpr ParserState var_def_assign_state =
    ParserState{var_def_assign_handler_};
...
constexpr ParserState var_def_assign_start_state =
    ParserState{var_def_assign_start_handler_};
...
constexpr ParserState var_def_type_start_state =
    ParserState{var_def_type_start_handler_};
...
auto var_def_identifier_handler_(ParserContext& ctx) -> ParserState {
  ...
  return ctx.move_next_state(var_def_error_state,
                             var_def_unexpected_end_error_state, conditions);
}

constexpr ParserState var_def_identifier_state =
    ParserState{var_def_identifier_handler_};
