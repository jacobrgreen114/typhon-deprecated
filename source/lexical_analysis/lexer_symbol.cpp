...
constexpr auto symbol_angle_open_unknown_state =
    LexerState{[](LexerContext &ctx) -> LexerState {
      ...
      return ctx.move_next_state(symbol_angle_open_state,
                                 symbol_angle_open_end_state, conditions);
    }};
...
constexpr auto symbol_angle_close_unknown_state =
    LexerState{[](LexerContext &ctx) -> LexerState {
      ...
      return ctx.move_next_state(symbol_angle_close_state,
                                 symbol_angle_close_end_state, conditions);
    }};
...
constexpr auto symbol_pipe_unknown_state =
    LexerState{[](LexerContext &ctx) -> LexerState {
      ...
      return ctx.move_next_state(symbol_pipe_state, symbol_pipe_end_state,
                                 conditions);
    }};
...
constexpr auto symbol_amp_unknown_state =
    LexerState{[](LexerContext &ctx) -> LexerState {
      ...
      return ctx.move_next_state(symbol_amp_state, symbol_amp_end_state,
                                 conditions);
    }};
...
constexpr auto symbol_caret_unknown_state =
    LexerState{[](LexerContext &ctx) -> LexerState {
      ...
      return ctx.move_next_state(symbol_caret_state, symbol_caret_end_state,
                                 conditions);
    }};
